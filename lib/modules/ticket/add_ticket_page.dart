        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16),
              _buildDropdown('Stage', controller.selectedPriority, controller.priorities, controller.onPriorityChanged), 
              const SizedBox(height: 16),
              _buildDropdown('SLA Policy', controller.selectedPriority, controller.priorities, controller.onPriorityChanged), 
              const SizedBox(height: 16),
